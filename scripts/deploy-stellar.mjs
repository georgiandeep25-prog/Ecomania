...
const alias = process.env.STELLAR_CONTRACT_ALIAS || "eco_mania";

const wasmCandidates = [
  path.join(rootDir, "target", "wasm32v1-none", "release", "eco_mania.wasm"),
  path.join(
    rootDir,
    "contracts",
    "eco_mania",
...
console.log(`Ecomania deployed to ${contractId} on ${network}`);
